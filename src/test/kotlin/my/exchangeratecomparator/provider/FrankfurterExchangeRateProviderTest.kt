...
class FrankfurterExchangeRateProviderTest {
    ...
    val provider: FrankfurterExchangeRateProvider = FrankfurterExchangeRateProvider(mockk<FrankfurterProperties>(), mockk< WebClient>())
    ...
    fun `check that file was parsed correctly`() {
        ...
        assertEquals(BigDecimal("5.7764"), rates[1].rate)
    }
